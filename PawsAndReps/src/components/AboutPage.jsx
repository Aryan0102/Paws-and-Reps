...
const AboutSection = () => {
  ...
  const highlightedMembers = teamMembers.filter(member => member.highlighted === "TRUE");
  const nonHighlightedMembers = teamMembers.filter(member => member.highlighted === "FALSE");
    ...
    <div className="bg-white">
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Non-highlighted team members */}
          {nonHighlightedMembers.length > 0 && (
            <div className="mt-20">
              <p className="text-3xl font-bold text-center mb-12">
                Our <span className="text-emerald-500">Team Members</span>
              </p>
              <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                {nonHighlightedMembers.map((member, index) => (
